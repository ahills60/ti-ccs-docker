...
RUN curl -L http://software-dl.ti.com/ccs/esd/CCSv9/CCS_9_2_0/exports/CCS9.2.0.00013_linux-x64.tar.gz --output /root/Downloads/CCS9.2.0.00013_linux-x64.tar.gz --silent && \
    tar xf /root/Downloads/CCS9.2.0.00013_linux-x64.tar.gz --directory /root/Downloads/
...
RUN rm /root/Downloads/CCS9.2.0.00013_linux-x64/ccs_setup_9.2.0.00013.bin
...
RUN curl -L http://software-dl.ti.com/simplelink/esd/simplelink_msp432e4_sdk/2.10.00.17/simplelink_msp432e4_sdk_2_10_00_17.run --output /root/Downloads/simplelink_msp432e4_sdk_2_10_00_17.run --silent && \
    chmod +x /root/Downloads/simplelink_msp432e4_sdk_2_10_00_17.run --mode unattended --prefix /opt/ti/
